...
```
**Answer:** It takes 17.278 seconds for the ingest+select+filter process, which is almost half of the time of the csv file. There are 24855909 rows and they match those in Q2.3.
...
```
**Answer:** It takes 32.784 seconds for the ingest+convert+select+filter process, which is almost same as the csv and slower than the parquet file. This may be because it has more commands than the Q2.4 and Q2.5. There are 24855909 rows and they match those in Q2.3.
