...
admissions_tble |> count(subject_id) |> 
  ggplot() + 
  geom_bar(mapping = aes(x = n)) + 
  labs(title = "Number of admissions per subject_id") + 
  xlab("Admissions") + 
  ylab("Number of subject_id") + 
  theme_bw()
```
