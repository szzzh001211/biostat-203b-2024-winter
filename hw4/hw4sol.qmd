...
labevents_tble <- tbl(con_bq, "labevents") |> 
  ...
  pivot_wider(names_from = itemid, values_from = valuenum, names_sort = TRUE) |> 
...
chartevents_tble <- tbl(con_bq, "chartevents") |>
  ...
  rename("heart_rate" = "220045", 
         "non-invasive_blood_pressure_systolic" = "220179", 
         "non-invasive_blood_pressure_diastolic" = "220180", 
         "respiratory_rate" = "220210", 
         "fahrenheit_temperature" = "223761") |>
  print(width = Inf)
