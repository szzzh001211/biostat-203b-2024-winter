...
filtered_labevents_csv <- labevents_csv |> 
  ...
  filter(itemid %in% c(50912, 50971, 50983, 50902, 
                       50882, 51221, 51301, 50931)) |> collect()
```
...
#filtered_labevents_csv$charttim <- attr(filtered_labevents_csv$charttime, "tzone") <- "UTC"
Sys.setenv(TZ = "UTC")
...
```{bash}
#| eval: false
zcat < ~/mimic/icu/chartevents.csv.gz | awk -F, 'BEGIN{OFS=","} {if \
($7 == 220045 || $7 == 220181 || $7 == 220179 || $7 == 223761 || $7 == 220210) \
print}' | gzip > ./chartevents_filtered.csv.gz
```
